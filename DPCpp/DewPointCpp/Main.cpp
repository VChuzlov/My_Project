...
int main()
{
    const std::vector<double> Tc{
        ...
        320.698,  314.899,  300.498,  294.899,  323.000,
        321.399,  306.100,  308.500,  329.198,  317.399,
        333.698,  318.100,  337.698,  319.000,  298.198,
        335.899,  354.777,  345.777,  337.222,  340.389
    };
    const std::vector<double> Pc{
        ...
        2512.850, 2492.590, 2381.120, 2330.370, 2553.370,
        2522.870, 2401.370, 2431.800, 2624.310, 2553.370,
        2685.110, 2522.870, 2735.770, 2604.050, 2479.370,
        2695.120, 2413.120, 2330.370, 2095.870, 2137.360
    };
    const std::vector<double> Af{
        ...
        0.370,    0.332,    0.321,    0.356,    0.330,
        0.352,    0.363,    0.343,    0.326,    0.330,
        0.347,    0.351,    0.279,    0.313,    0.312,
        0.313,    0.376,    0.404,    0.461,    0.463
    };
    const std::vector<double> Vc{
        ...
        0.490,    0.498,    0.507,    0.519,    0.491,
        0.494,    0.509,    0.500,    0.484,    0.486,
        0.477,    0.489,    0.478,    0.490,    0.504,
        0.481,    0.510,    0.519,    0.596,    0.582
    };
    const double Pressure = 101.325;
    const std::vector<double> Yi(100, 0.01);    
